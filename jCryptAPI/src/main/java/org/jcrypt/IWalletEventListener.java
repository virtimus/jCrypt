...
public interface IWalletEventListener {
     ...
     */
    void onCoinsReceived(IWallet wallet, ITransaction tx, BigInteger prevBalance, BigInteger newBalance);
     ...
     */
    void onCoinsSent(IWallet wallet, ITransaction tx, BigInteger prevBalance, BigInteger newBalance);
     ...
     */
    void onReorganize(IWallet wallet);
     ...
     */
    void onTransactionConfidenceChanged(IWallet wallet, ITransaction tx);
     ...
     */
    void onWalletChanged(IWallet wallet);
     ...
     */
    void onKeysAdded(IWallet wallet, List<IECKey> keys);

    /** Called whenever a new watched script is added to the wallet. */
    void onScriptsAdded(IWallet wallet, List<IScript> scripts);
}
